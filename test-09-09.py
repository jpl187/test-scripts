...
# Initialize client
username = input("Enter VaaS username: ")
password = getpass("Enter VaaS password: ")

# Create a Vaas client instance with username and password authentication
client = Vaas(username=username, password=password)
